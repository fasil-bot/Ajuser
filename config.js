...
module.exports = {
    ...
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? '.left' : process.env.KICKME_MESSAGE,
    ...
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? '.mute' : process.env.MUTE_MESSAGE,
